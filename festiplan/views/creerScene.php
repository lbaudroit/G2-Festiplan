    ...
    <div class="contenue container">
        <div class="col-12">
            <form method="post" class="formulaire">
                <div class="row">
                    <u class="text-center textFormulaire">
                        <hspan class="titre">
                            Ajout d'une scène
                            </span>
                    </u>
                    <u class="offset-2 col-4">
                        <h5>
                            Nom de la scène :
                        </h5>
                    </u>
                    <input type="text" id="nomScene" name="nomScene" class="offset-1 col-3 textFormulaire"
                        placeholder="Entrer le nom de la scène (35 caractères max.)" <?php
                ...
                <div class="row">
                    ...
                    <select name="tailleScene" id="tailleSceneSelect"
                        class="textFormulaire text-center offset-1 col-3 ">
                ...
                <div class="row">
                    <a type="button"
                        href="index.php?controller=festival&action=createScene&festival=<?php echo $fest; ?>"
                        class="offset-2 col-3 btn btn-rouge">Annuler</a>
